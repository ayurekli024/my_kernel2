...
// Standart 8x8 ASCII Font Haritası (Karakterler 0-127 arası)
static const unsigned char font8x8[128][8] = {
    // 0-31 arası kontrol karakterleri (Boş bırakıyoruz)
    ...
    [36] = {0x08, 0x3E, 0x03, 0x1E, 0x30, 0x3E, 0x08, 0x00}, // $
    [37] = {0x00, 0x63, 0x33, 0x18, 0x0C, 0x66, 0x63, 0x00}, // %
    [38] = {0x1C, 0x36, 0x1C, 0x3A, 0x6E, 0x66, 0x3B, 0x00}, // &
    ...
    // Rakamlar (0-9)
    [48] = {0x3C, 0x66, 0x66, 0x6E, 0x76, 0x66, 0x3C, 0x00}, // 0
    ...
    [55] = {0x7E, 0x06, 0x06, 0x0C, 0x18, 0x18, 0x18, 0x00}, // 7
    ...
    // [ ... ] \ ^ _
    [91] = {0x3E, 0x30, 0x30, 0x30, 0x30, 0x30, 0x3E, 0x00}, // [
    [92] = {0x00, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x00, 0x00}, // Ters Egik Cizgi
    ...
    [106] = {0x06, 0x00, 0x16, 0x06, 0x06, 0x66, 0x3C, 0x00}, // j
    ...
    [126] = {0x00, 0x34, 0x58, 0x00, 0x00, 0x00, 0x00, 0x00}, // ~
